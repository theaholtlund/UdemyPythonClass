...
# Defining a function to format the data
...
# Initialising Colorama with necessary configurations
colorama.init()

# Testing out the results for various input values for numbers
...
# Clean up and restore the terminal to its original state before Colorama was initialised
colorama.deinit()
