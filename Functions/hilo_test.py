# Creating a function to test variables for the hilo game
# In this version, we test the guess against the answer
# Defining the low and high variables as constants
LOW = 1
HIGH = 1000
...
# Prints out each number that was guessed and the number of guesses needed
# Also added code to check how many times the computer got the right guess
correct_count = 0
max_guesses = 0
