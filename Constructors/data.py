# Defining some data to work with in exploring named tuples
from collections import namedtuple

# List of tuples describing people
people = [
...
# Defining two examples of named tuples
...
# List of tuples describing plants
basic_plants_list = [
...
# Using the named tuple to create lists
plants_list = [
...
# Dictionary of tuples describing more plants through the named tuple
plants_dict = {
